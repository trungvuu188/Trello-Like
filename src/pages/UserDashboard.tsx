      ...
      <div className="w-64 bg-gray-800 flex flex-col">
        <div className="p-4">
          ...
          <nav className="space-y-1 border-b py-2">
            <a href="#" className="flex items-center px-3 py-2 text-sm font-medium text-[#569EFF] bg-[#1C2B41] rounded-lg">
              <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
              </svg>
              Boards
            </a>
            <a href="#" className="flex items-center px-3 py-2 text-sm font-medium text-white hover:bg-[#A6C5E229] rounded-lg">
              <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex-1 px-4">
          <div className="mb-4">
            <h3 className="text-xs font-semibold text-white uppercase tracking-wide mb-2">Workspaces</h3>
            <div className="space-y-1">
              <div className="flex items-center justify-between p-2 hover:bg-[#A6C5E229] rounded-lg cursor-pointer">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-orange-500 rounded flex items-center justify-center text-black font-semibold text-sm mr-3">
                    N
                  </div>
                  <span className="text-sm font-medium text-white">Nashtech</span>
                </div>
              ...
              {/* Workspace submenu */}
              <div className="space-y-1">
                <a href="#" className="pl-11 block px-3 py-1.5 text-sm text-white hover:bg-[#A6C5E229] rounded">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {recentBoards.map((board) => (
                <div key={board.id} className="shadow-md group cursor-pointer">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-medium text-white">Nashtech</h3>
                </div>
              ...
              <div className="pb-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {workspaceBoards.map((board) => (
                  <div key={board.id} className="group shadow-md cursor-pointer">
                    <div className={`${board.color} rounded-lg h-24 relative overflow-hidden`}>
                      <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-200"></div>
                    </div>
